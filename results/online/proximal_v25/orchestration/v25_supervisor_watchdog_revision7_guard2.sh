...
SUPERVISOR_SESSION=safe100_v25_completion_supervisor_revision7_guard2
SUPERVISOR_STATE="$ORCHESTRATION_ROOT/supervisor_state_revision7_guard2.json"
COMPLETION_LOCK="$ORCHESTRATION_ROOT/completion_orchestrator.lock"
COMPLETION_PROCESS_PATTERN='^bash /home/carla/LZQW/SAFE100/humanoid/artifacts/v25_complete_after_calibration_revision7_guard2\.sh$'
...
QUEUE_PROCESS_PATTERN='^bash /home/carla/LZQW/SAFE100/humanoid/artifacts/v25_wait_and_calibrate_revision7_guard2\.sh$'
WATCHDOG_STATE="$ORCHESTRATION_ROOT/supervisor_watchdog_state_revision7_guard2.json"
WATCHDOG_LOG="$ORCHESTRATION_ROOT/supervisor_watchdog_revision7_guard2.log"
POLL_SECONDS=60
MAX_RESTARTS=12
