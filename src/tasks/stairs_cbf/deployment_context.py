...
V21_CONTEXT_SPECS: dict[str, dict[str, Any]] = {
  ...
  "C4": {
    ...
    "formal": True,
    "candidate_seed_prefix": 401,
    "direction": 1,
    "ranges": {
      "foot_friction": [0.456745, 0.447964],
      "command_forward_scale": [1.092982, 1.099855],
      "command_low_pass_s": [0.076764, 0.082109],
      "action_gain": [0.915127, 0.909018],
    },
  },
  "C5": {
    "mode": "contact_stability",
