...
V21_CONTEXT_SPECS: dict[str, dict[str, Any]] = {
  ...
  "C4": {
    ...
    "formal": True,
    "candidate_seed_prefix": 381,
    "direction": 1,
    "ranges": {
      "foot_friction": [0.4626, 0.4465],
      "command_forward_scale": [1.0884, 1.1010],
      "command_low_pass_s": [0.0732, 0.0830],
      "action_gain": [0.9192, 0.9080],
    },
  },
  "C5": {
    "mode": "contact_stability",
