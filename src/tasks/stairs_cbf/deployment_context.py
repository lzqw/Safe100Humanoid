...
V21_CONTEXT_SPECS: dict[str, dict[str, Any]] = {
  ...
  "L2": {
    ...
    "ranges": {
      ...
      "yaw_bias_abs": [0.18, 0.32],
      "lateral_pulse_min": [0.035, 0.035],
      "lateral_pulse_max": [0.085, 0.085],
      "yaw_pulse_min": [0.24, 0.38],
      "yaw_pulse_max": [0.50, 0.78],
      "centerline_lateral_gain": [0.50, 0.50],
