...
V21_CONTEXT_SPECS: dict[str, dict[str, Any]] = {
  ...
  "L2": {
    ...
    "ranges": {
      ...
      "action_delay_steps": [0, 0],
      "encoder_bias_abs": [0.001, 0.001],
      "yaw_bias_abs": [0.12, 0.32],
      "lateral_pulse_min": [0.020, 0.020],
      "lateral_pulse_max": [0.050, 0.050],
      "yaw_pulse_min": [0.16, 0.34],
      "yaw_pulse_max": [0.34, 0.72],
      "centerline_lateral_gain": [0.50, 0.50],
