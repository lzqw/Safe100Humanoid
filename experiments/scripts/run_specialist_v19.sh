...
SEED="${SAFE100_SEED:?set SAFE100_SEED to 63, 163, 263, 363, or 463}"
...
OUTPUT="${SAFE100_OUTPUT_DIR:-$ROOT/artifacts/specialist_v19_revision4/training/${MODE}/seed${SEED}}"
LOG="${SAFE100_LOG_PATH:-$ROOT/logs/specialist_v19_revision4/train_${MODE}_seed${SEED}.log}"
...
case "$SEED" in
  63|163|263|363|463) ;;
  *) echo "formal v19 revision-4 seed must be 63, 163, 263, 363, or 463" >&2; exit 2 ;;
esac
