...
DEFAULT_CANDIDATE_TEMPLATE="$ROOT/artifacts/dominant_failure_v16/train_seed{seed}/accepted_final.pt"
CANDIDATE_TEMPLATE="${SAFE100_CANDIDATE_TEMPLATE:-$DEFAULT_CANDIDATE_TEMPLATE}"
OUTPUT="${SAFE100_AUDIT_OUTPUT_DIR:-$ROOT/artifacts/dominant_failure_v16/final_audit}"
LOG="${SAFE100_AUDIT_LOG_PATH:-$ROOT/logs/dominant_failure_v16/final_audit.log}"
