...
test "$PHASE" = calibration && DEFAULT_REPO="$ROOT/worktrees/v21_precalibration"
...
test "$PHASE" = calibration && DEFAULT_PROTOCOL="$REPO/results/online/specialist_v21/protocol_precalibration.json"
