...
OUTPUT="${SAFE100_OUTPUT_ROOT:-$ROOT/artifacts/online_framework_v3/staged_dq_to_d4_v11}"
LOG="${SAFE100_LOG_PATH:-$ROOT/logs/online_framework_v3/staged_dq_to_d4_v11.log}"
